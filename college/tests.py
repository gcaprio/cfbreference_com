...
class CollegeTestCase(TestCase):
    ...
    def testURL(self):
        self.assertEquals(self.florida.get_absolute_url(), '/teams/florida/')
        
    def test_details(self):
        response = self.client.get('/teams/florida/')
